...
class ChatterSignUp extends StatefulWidget {
  ...
  const ChatterSignUp({Key? key, required this.onToggle}) : super(key: key);
                      ...
                      onpress: () async {
                        if (_isSignupValid()) {
                          ...
                          try {
                            ...
                            if (user != null && (name?.isNotEmpty ?? false)) {
                            ...
                            _showAlert(context, 'Signup Failed', e.toString());
                          }
                        } else {
                          _showAlert(context, 'Signup Failed',
